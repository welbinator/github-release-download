...
Remote Download is a simple block plugin for WordPress that allows you to create a customizable button that downloads the latest release from any public GitHub repository.
